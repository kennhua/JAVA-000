package com.kennhua.rpcfx.common;
...
public class InvokerFactory {
    ...
    public static RpcInvoker getInvoker(Class<?> clazz) throws Exception {
        ...
        CtClass invokerClass = pool.makeClass(RpcInvoker.class.getName() + CLASS_COUNTER.getAndIncrement(), pool.getCtClass("com.kennhua.rpcfx.api.RpcInvoker"));
